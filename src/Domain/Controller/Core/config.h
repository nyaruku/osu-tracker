...
namespace config {
	...
	namespace data {
		...
		std::vector<dataEntry> arr {
			...
			,{"rankedScore","Ranked Score",		2, "", "",	"", dataType::d_longLong,	formatType::f_int,		false, true, true,	true,	true}
			,{"totalScore",	"Total Score",		3, "", "",	"", dataType::d_longLong,	formatType::f_int,		false, true, true,	true,	true}
			,{"ppRank",		"PP Rank",			4, "", "",	"", dataType::d_int,		formatType::f_rank,		false, true, true,	true,	true}
			,{"pp",			"PP",				5, "", "",	"", dataType::d_float,		formatType::f_decimal,	false, true, true,	true,	true}
			,{"ppv1",		"PPv1",				6, "", "",	"", dataType::d_float,		formatType::f_decimal,	false, true, true,	false,	true}
			,{"acc",		"Accuracy",			7, "", "",	"", dataType::d_float,		formatType::f_percent,	false, true, true,	true,	true}
			,{"playtime",	"Play Time",		8, "", "",	"", dataType::d_longLong,	formatType::f_time,		false, true, true,	true,	true}
			,{"playcount",	"Play Count",		9, "", "",	"", dataType::d_int,		formatType::f_int,		false, true, true,	true,	true}
			,{"totalHits",	"Total Hits",		10, "", "",	"", dataType::d_longLong,	formatType::f_int,		false, true, true,	false,	true}
			,{"silverSS",	"Rank SSH",			11, "", "",	"", dataType::d_int,		formatType::f_int,		false, true, true,	true,	true}
			,{"goldSS",		"Rank SS",			12, "", "",	"", dataType::d_int,		formatType::f_int,		false, true, true,	true,	true}
			,{"silverS",	"Rank SH",			13, "", "",	"", dataType::d_int,		formatType::f_int,		false, true, true,	true,	true}
			,{"goldS",		"Rank S",			14, "", "",	"", dataType::d_int,		formatType::f_int,		false, true, true,	true,	true}
			,{"a",			"Rank A",			15, "", "",	"", dataType::d_int,		formatType::f_int,		false, true, true,	true,	true}
			,{"b",			"Rank B",			16, "", "",	"", dataType::d_int,		formatType::f_int,		false, true, true,	true,	true}
			,{"c",			"Rank C",			17, "", "",	"", dataType::d_int,		formatType::f_int,		false, true, true,	true,	true}
			,{"d",			"Rank D",			18, "", "",	"", dataType::d_int,		formatType::f_int,		false, true, true,	true,	true}
			,{"totalSS",	"Total SS",			19, "", "",	"", dataType::d_int,		formatType::f_int,		false, true, true,	true,	true}
			,{"totalS",		"Total S",			20, "", "",	"", dataType::d_int,		formatType::f_int,		false, true, true,	true,	true}
			,{"clears",		"Profile Clears",	21, "", "",	"", dataType::d_int,		formatType::f_int,		false, true, true,	true,	true}
			,{"totalClears","Total Clears",		22, "", "",	"", dataType::d_int,		formatType::f_int,		false, true, true,	true,	true}
			,{"completion",	"Completion%",		23, "", "",	"", dataType::d_float,		formatType::f_percent,	false, true, true,	true,	true}
			,{"scoreRank",	"Score Rank",		24, "", "",	"", dataType::d_int,		formatType::f_rank,		false, true, true,	true,	false}
			,{"targetRank",	"Target Rank",		25, "", "",	"", dataType::d_int,		formatType::f_rank,		true,  true, true,	true,	false}
			,{"targetUser",	"Target Player",	26, "", "",	"", dataType::d_string,		formatType::f_string,	true,  true, true,	true,	false}
			,{"targetScore","Target Score",		27, "", "",	"", dataType::d_longLong,	formatType::f_int,		true,  true, true,	true,	false}
		};
